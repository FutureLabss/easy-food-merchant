...
import { useOrderQueryObject, useSingleOrderQuery } from '@/hooks/query/order';
...
export default function OrderPage() {
    ...
    const {data} = useOrderQueryObject();
    console.log({data})
    
    // const {data:item} = useSingleOrderQuery()
    console.log("fsdvuierlf")
